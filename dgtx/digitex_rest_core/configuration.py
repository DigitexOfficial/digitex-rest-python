...
conf = dgtx.digitex_rest_core.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://testnet.digitexfutures.com/dapi" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("digitex_rest_core")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'TradersToken' in self.api_key:
            auth['TradersToken'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
