...
class RateLimits(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, interval, limit, *args, **kwargs):  # noqa: E501
        """RateLimits - a model defined in OpenAPI

        Args:
            interval (str): Frequency of rate limit
            limit (int): Current trader's allowed frequency.
    ...
    @convert_js_args_to_python_args
    def __init__(self, interval, limit, *args, **kwargs):  # noqa: E501
        """RateLimits - a model defined in OpenAPI
