...
class OrderDuration(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OrderDuration - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): Duration of the order          UNDEFINED - 0     GFD - 1     GTC - 2     GTF - 3     IOC - 4     FOK - 5., must be one of [0, 1, 2, 3, 4, 5, ]  # noqa: E501

        Keyword Args:
            value (int): Duration of the order          UNDEFINED - 0     GFD - 1     GTC - 2     GTF - 3     IOC - 4     FOK - 5., must be one of [0, 1, 2, 3, 4, 5, ]  # noqa: E501
