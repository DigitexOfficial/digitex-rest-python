...
class OrderPosition(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (int): Order positions          UNDEFINED - 0     LONG -1     SHORT - 2., must be one of [0, 1, 2, ]  # noqa: E501

        Keyword Args:
            value (int): Order positions          UNDEFINED - 0     LONG -1     SHORT - 2., must be one of [0, 1, 2, ]  # noqa: E501
