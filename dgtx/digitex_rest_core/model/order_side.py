...
class OrderSide(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OrderSide - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): Order sides          UNDEFINEd - 0       BUY - 1     SELL - 2., must be one of [0, 1, 2, ]  # noqa: E501

        Keyword Args:
            value (int): Order sides          UNDEFINEd - 0       BUY - 1     SELL - 2., must be one of [0, 1, 2, ]  # noqa: E501
