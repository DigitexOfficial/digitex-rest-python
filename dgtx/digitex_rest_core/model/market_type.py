...
class MarketType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MarketType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): Market types 1 - FUTURES 2 - SPOT., must be one of [1, 2, ]  # noqa: E501

        Keyword Args:
            value (int): Market types 1 - FUTURES 2 - SPOT., must be one of [1, 2, ]  # noqa: E501
