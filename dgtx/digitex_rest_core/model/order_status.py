...
class OrderStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (int): Order statuses          PENDING - 1     ACCEPTED - 2     REJECTED - 3     CANCELED - 4     FILLED - 5     PARTIAL - 6., must be one of [1, 2, 3, 4, 5, 6, ]  # noqa: E501

        Keyword Args:
            value (int): Order statuses          PENDING - 1     ACCEPTED - 2     REJECTED - 3     CANCELED - 4     FILLED - 5     PARTIAL - 6., must be one of [1, 2, 3, 4, 5, 6, ]  # noqa: E501
