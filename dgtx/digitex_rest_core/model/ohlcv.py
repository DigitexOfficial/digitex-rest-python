...
def lazy_import():
    ...
    globals()['OHLCVList'] = OHLCVList


class OHLCV(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ohlcv, *args, **kwargs):  # noqa: E501
        """OHLCV - a model defined in OpenAPI

        Args:
            ohlcv ([OHLCVList]): result of the query
        ...
        Keyword Args:
            ...
            timestamp (int): Timestamp of the request. [optional]  # noqa: E501
            market_id (int): market id. [optional]  # noqa: E501
            resolution (str): selected timeframe. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, ohlcv, *args, **kwargs):  # noqa: E501
        """OHLCV - a model defined in OpenAPI
