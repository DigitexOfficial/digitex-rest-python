...
from dgtx.digitex_rest_core import rest
from dgtx.digitex_rest_core.configuration import Configuration
from dgtx.digitex_rest_core.exceptions import ApiTypeError, ApiValueError, ApiException
from dgtx.digitex_rest_core.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ExchangeMetaDataApi()
        api_instance.v1_exchange_bot_currency_get  # this is an instance of the class Endpoint
        api_instance.v1_exchange_bot_currency_get()  # this invokes api_instance.v1_exchange_bot_currency_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_exchange_bot_currency_get.callable or self.callable in this class
